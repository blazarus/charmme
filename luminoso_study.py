...
EXTRA_STOPWORDS = ['also', 'without', 'ever', 'because', 'then', 'than', 'do', 'just', 'how', 'out', 'much', 'use', 'both', 'each', 'other', 'uses', 'using', 'everyday', 'within', 'through', 'over']
...
class Study(object):
    ...
    def get_documents_matrix(self):
        ...
        documents_matrix = divisi2.make_sparse(entries).normalize_all()
        canon_entries = []
